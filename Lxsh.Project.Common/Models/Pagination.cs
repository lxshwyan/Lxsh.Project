...
namespace Lxsh.Project.Common
{
    ...
    public class Pagination<T>
    {
        ...
        /// 排序类型
        /// </summary>
        public int sord { get => _sortType; set => _sortType = value; }
        ...
        /// <returns></returns>
        public object BuildTableResult_JqGrid(List<T> dataList)
        {
            _watch.Stop();
        ...
        /// <param name="dataList">返回的数据列表</param>
        /// <returns></returns>
        public object BuildTableResult_Layui(List<T> dataList)
        {
            _watch.Stop();
        ...
        /// 排序类型
        /// </summary>
        public int order { get => _sortType; set => _sortType = value; }
        ...
        /// <param name="dataList">返回的数据列表</param>
        /// <returns></returns>
        public object BuildTableResult_DataGrid(List<T> dataList)
        {
            _watch.Stop();
