...
using System.Data;
using System.Data.SQLite;//下载dll并添加引用
...
namespace Lxsh.Project.ConsoleDemo
{
    ...
    {
        //数据库连接字符串，可以动态更改SQLString支持多个数据库
        ...
        private static string CreateConnectionString()
         {
             ...
             string dbName = ConfigurationManager.AppSettings["SQLiteDB"]??"sfbr.db";
    ...
    public static int GetMaxID(string FieldName, string TableName)
        ...
        /// <summary>
        /// 执行带一个参数的的SQL语句 ExecuteNonQuery
        /// </summary>
        /// <param name="SQLString">SQL语句</param>
        ...
        public static Int32 updateDB(string selectStr, System.Data.DataTable dt)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
                SQLiteDataAdapter command = new SQLiteDataAdapter(selectStr, connection);
                new SQLiteCommandBuilder(command);
                Int32 res = command.Update(dt);
                return res;
            }
        }
