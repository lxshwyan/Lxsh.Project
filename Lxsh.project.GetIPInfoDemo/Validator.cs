...
namespace Lxsh.project.GetIPInfoDemo
{
    public class Validator
    {
        ...
        #region 获取制定规则字符串
        public static string GetIP(string inputStr)
        {
            string patternStr = @"(2[0-4]\d|25[0-5]|[01]\d\d|\d\d|\d)\.(2[0-4]\d|25[0-5]|[01]\d\d|\d\d|\d)\.(2[0-4]\d|25[0-5]|[01]\d\d|\d\d|\d)\.(2[0-4]\d|25[0-5]|[01]\d\d|\d\d|\d)";
